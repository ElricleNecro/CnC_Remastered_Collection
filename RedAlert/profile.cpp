...
bool Read_Private_Config_Struct(FileClass &file, NewConfigType *config) {
	...
	//	config->IRQ 			= WWGetPrivateProfileInt("Sound", "IRQ", 0,profile); 	config->DMA
	//= WWGetPrivateProfileInt("Sound", "DMA", 			 0,profile); 	config->Port =
	//WWGetPrivateProfileHex("Sound", "Port", 			 profile); 	config->BitsPerSample=
	// WWGetPrivateProfileInt("Sound", "BitsPerSample",0,profile); 	config->Channels 		=
	// WWGetPrivateProfileInt("Sound", "Channels",		 0,profile); 	config->Reverse      =
	// WWGetPrivateProfileInt("Sound", "Reverse", 		 0,profile); 	config->Speed        =
	// WWGetPrivateProfileInt("Sound", "Speed", 		 0,profile); 	WWGetPrivateProfileString("Language",
