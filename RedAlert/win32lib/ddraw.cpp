...
void Process_DD_Result(HRESULT result, int display_ok_msg) {
	...
	case DDERR_CANNOTATTACHSURFACE:
		MessageBox(MainWindow, "This surface can not be attached to the requested surface.	", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_CANNOTDETACHSURFACE:
		MessageBox(MainWindow, "This surface can not be detached from the requested surface.	", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_CANTDUPLICATE:
		MessageBox(MainWindow,
			   "Can't duplicate primary & 3D surfaces, or surfaces that are implicitly created.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_COLORKEYNOTSET:
		MessageBox(MainWindow, "No src color key specified for this operation.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_EXCEPTION:
		MessageBox(MainWindow, "An exception was encountered while performing the requested operation.	",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_HEIGHTALIGN:
		MessageBox(MainWindow, "Height of rectangle provided is not a multiple of reqd alignment.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_HWNDALREADYSET:
		MessageBox(MainWindow,
			   "The CooperativeLevel HWND has already been set. It can not be reset while the process has "
	...
	case DDERR_IMPLICITLYCREATED:
		MessageBox(MainWindow, "This surface can not be restored because it is an implicitly created surface.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INCOMPATIBLEPRIMARY:
		MessageBox(MainWindow,
			   "Unable to match primary surface creation request with existing primary surface.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDCAPS:
		MessageBox(MainWindow, "One or more of the caps bits passed to the callback are incorrect.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDCLIPLIST:
		MessageBox(MainWindow, "DirectDraw does not support the provided cliplist.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDDIRECTDRAWGUID:
		MessageBox(MainWindow,
			   "The GUID passed to DirectDrawCreate is not a valid DirectDraw driver identifier.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDMODE:
		MessageBox(MainWindow, "DirectDraw does not support the requested mode.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDOBJECT:
		MessageBox(MainWindow, "DirectDraw received a pointer that was an invalid DIRECTDRAW object.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDPARAMS:
		MessageBox(MainWindow, "One or more of the parameters passed to the function are incorrect.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDPIXELFORMAT:
		MessageBox(MainWindow, "The pixel format was invalid as specified.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_INVALIDPOSITION:
		MessageBox(MainWindow,
			   "Returned when the position of the overlay on the destination is no longer legal for that "
			   "destination.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_LOCKEDSURFACES:
		MessageBox(MainWindow, "Operation could not be carried out because one or more surfaces are locked.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NO3D:
	...
	case DDERR_NOALPHAHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no alpha accleration hardware present "
			   "or available.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
#if (0)
	case DDERR_NOANTITEARHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no hardware support for synchronizing "
			   "blts to avoid tearing.	",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
#endif
	case DDERR_NOBLTHW:
	...
	case DDERR_NOBLTQUEUEHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no hardware support for asynchronous "
			   "blting.	",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
#endif
	...
	case DDERR_NOCLIPPERATTACHED:
		MessageBox(MainWindow, "No clipper object attached to surface object.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOCOLORCONVHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no color conversion hardware present "
			   "or available.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOCOLORKEY:
		MessageBox(MainWindow, "Surface doesn't currently have a color key", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOCOLORKEYHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no hardware support of the destination "
			   "color key.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_NODIRECTDRAWSUPPORT:
		MessageBox(MainWindow, "No DirectDraw support possible with current display driver.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_NOEXCLUSIVEMODE:
		...
		break;
	case DDERR_NOFLIPHW:
		MessageBox(MainWindow, "Flipping visible surfaces is not supported.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOGDI:
	...
	case DDERR_NOOVERLAYDEST:
		MessageBox(MainWindow,
			   "Returned when GetOverlayPosition is called on an overlay that UpdateOverlay has never been "
	...
	case DDERR_NOPALETTEATTACHED:
		MessageBox(MainWindow, "No palette object attached to this surface.	", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOPALETTEHW:
		MessageBox(MainWindow, "No hardware support for 16 or 256 color palettes.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_NOT4BITCOLOR:
		MessageBox(MainWindow,
			   "DirectDrawSurface is not in 4 bit color palette and the requested operation requires 4 bit "
			   "color palette.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOT4BITCOLORINDEX:
		MessageBox(MainWindow,
			   "DirectDrawSurface is not in 4 bit color index palette and the requested operation requires "
	...
	case DDERR_NOTAOVERLAYSURFACE:
		MessageBox(MainWindow, "Returned when an overlay member is called for a non-overlay surface.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOTEXTUREHW:
		MessageBox(MainWindow,
			   "Operation could not be carried out because there is no texture mapping hardware present or "
			   "available.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOTFLIPPABLE:
		MessageBox(MainWindow, "An attempt has been made to flip a surface that is not flippable.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOTFOUND:
	...
	case DDERR_NOTLOCKED:
		MessageBox(MainWindow,
			   "Surface was not locked.  An attempt to unlock a surface that was not locked at all, or by "
			   "this process, has been attempted.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_NOTPALETTIZED:
		MessageBox(MainWindow, "The surface being used is not a palette-based surface.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_NOZOVERLAYHW:
		MessageBox(MainWindow,
			   "Overlay surfaces could not be z layered based on their BltOrder because the hardware does "
			   "not support z layering of overlays.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_OUTOFCAPS:
		MessageBox(MainWindow, "The hardware needed for the requested operation has already been allocated.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_OUTOFMEMORY:
		MessageBox(MainWindow, "DirectDraw does not have enough memory to perform the operation.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_OVERLAYCANTCLIP:
		MessageBox(MainWindow, "The hardware does not support clipped overlays.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_OVERLAYCOLORKEYONLYONEACTIVE:
		MessageBox(MainWindow, "Can only have ony color key active at one time for overlays.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_OVERLAYNOTVISIBLE:
		MessageBox(MainWindow, "Returned when GetOverlayPosition is called on a hidden overlay.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_PRIMARYSURFACEALREADYEXISTS:
		MessageBox(MainWindow, "This process already has created a primary surface.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_REGIONTOOSMALL:
		MessageBox(MainWindow, "Region passed to Clipper::GetClipList is too small.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_SURFACEALREADYATTACHED:
		MessageBox(MainWindow, "This surface is already attached to the surface it is being attached to.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_SURFACEISOBSCURED:
		MessageBox(MainWindow, "Access to surface refused because the surface is obscured.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_TOOBIGHEIGHT:
		MessageBox(MainWindow, "Height requested by DirectDraw is too large.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_TOOBIGWIDTH:
		MessageBox(MainWindow, "Width requested by DirectDraw is too large.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_UNSUPPORTEDFORMAT:
		MessageBox(MainWindow, "FOURCC format requested is unsupported by DirectDraw.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_UNSUPPORTEDMASK:
		MessageBox(MainWindow, "Bitmask in the pixel format requested is unsupported by DirectDraw.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	...
	case DDERR_WASSTILLDRAWING:
		MessageBox(MainWindow,
			   "Informs DirectDraw that the previous Blt which is transfering information to or from this "
			   "Surface is incomplete.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_WRONGMODE:
		MessageBox(MainWindow, "This surface can not be restored because it was created in a different mode.",
			   "Note", MB_ICONEXCLAMATION | MB_OK);
		break;
	case DDERR_XALIGN:
		MessageBox(MainWindow, "Rectangle provided was not horizontally aligned on required boundary.", "Note",
			   MB_ICONEXCLAMATION | MB_OK);
		break;
	default:
		char string[256];
...
BOOL Set_Video_Mode(HWND hwnd, int w, int h, int bits_per_pixel) {
	...
	result =
	    DirectDrawObject->CreatePalette(DDPCAPS_8BIT | DDPCAPS_ALLOW256, &PaletteEntries[0], &PalettePtr, NULL);
	Process_DD_Result(result, FALSE);
	if (result != DD_OK) {
		return (FALSE);
	}
...
unsigned int Get_Free_Video_Memory(void) {
	...
	if (DirectDrawObject) {
		...
		// MessageBox(MainWindow, "In Get_Free_Video_Memory. About to call GetCaps","Note",
		// MB_ICONEXCLAMATION|MB_OK);
...
void Set_DD_Palette(void *palette) {
	...
	*/
	...
	if (DirectDrawObject && PaletteSurface) {
		...
		if (!FirstPaletteSet) {
			// MessageBox(MainWindow, "In Set_DD_Palette. About to call SetPalette","Note",
			// MB_ICONEXCLAMATION|MB_OK);
			PaletteSurface->SetPalette(PalettePtr);
			FirstPaletteSet = TRUE;
		}

		// MessageBox(MainWindow, "In Set_DD_Palette. About to call SetEntries","Note",
		// MB_ICONEXCLAMATION|MB_OK);
