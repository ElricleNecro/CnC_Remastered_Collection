 ...
 *-------------------------------------------------------------------------*
 * Functions:                                                              *
 *   Set_Palette -- sets the current palette * Set_Palette_Color -- Set a color number in a palette to the data.     *
 ...
 ** int color		- which color index to set * void *data		- RGB data for color
 **
 *                                                                         *
 * OUTPUT:                                                                 *
 *		none
 ...
 *-	fade with this timer count down							* void *callback  - user-defined
 *callback function							*
 *                                                                         *
 * OUTPUT:     none                                                        *
 *                                                                         *
 ...
 ** int delay		- desired time delay in 60ths of a second					* short *ticks
 *- output: loop ticks per color jump							* short *rate		-
 *output: color gun increment rate							*
 *                                                                         *
 * OUTPUT:                                                                 *
 *		none
 **
