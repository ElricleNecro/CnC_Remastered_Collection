...
typedef enum WinCommDialMethodType { WC_TOUCH_TONE = 0, WC_PULSE } WinCommDialMethodType;
...
public:
	...
	*/
	enum SendModemEnum { MODEM_CMD_TIMEOUT = 0, MODEM_CMD_OK, MODEM_CMD_0, MODEM_CMD_ERROR };
