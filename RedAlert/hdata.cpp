 ...
 *=============================================================================================*/
HouseTypeClass::HouseTypeClass(HousesType house, char const *ini, int fullname, char const *ext, int lemon,
    ...
    : AbstractTypeClass(RTTI_HOUSETYPE, house, fullname, ini),
      ...
      //	IniName(ini),
      //	FullName(fullname),
      Lemon(lemon), RemapColor(remapcolor), Prefix(prefix), FirepowerBias(1), GroundspeedBias(1), AirspeedBias(1),
 ...
 *=============================================================================================*/
void *HouseTypeClass::operator new(size_t) { return (HouseTypes.Alloc()); }
 ...
 *   09/04/1996 JLB : Created.                                                                 *
 *=============================================================================================*/
void HouseTypeClass::operator delete(void *ptr) { HouseTypes.Free((HouseTypeClass *)ptr); }
 ...
 *=============================================================================================*/
HouseTypeClass &HouseTypeClass::As_Reference(HousesType house) { return (*HouseTypes.Ptr(house)); }
 ...
 *=============================================================================================*/
unsigned char const *HouseTypeClass::Remap_Table(void) const { return (ColorRemaps[RemapColor].RemapTable); }
