 ...
 *=============================================================================================*/
HouseTypeClass::HouseTypeClass(HousesType house, char const *ini, int fullname, char const *ext, int lemon, PlayerColorType remapcolor, char prefix)
	: AbstractTypeClass(RTTI_HOUSETYPE, house, fullname, ini),
	  ...
	  //	IniName(ini),
	  //	FullName(fullname),
	  Lemon(lemon), RemapColor(remapcolor), Prefix(prefix), FirepowerBias(1), GroundspeedBias(1), AirspeedBias(1), ArmorBias(1), ROFBias(1),
	  CostBias(1), BuildSpeedBias(1) {
