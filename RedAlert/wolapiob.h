...
public:
	...
	//	CREATEGAMEINFO::GAMEKIND GameKindCurrent;	//	Kind of game (Red Alert, CS, AM) we are in game
	// setup for.
	CREATEGAMEINFO
	GameInfoCurrent; //	Kind of game (Red Alert, CS, AM, tournament, private) we are in game setup for.
