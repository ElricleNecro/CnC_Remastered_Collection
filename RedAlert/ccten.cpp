 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		id			connection ID to destroy (must be a HousesType) * error		0 = user signed
 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		whom		name of player we're allying / enemying with * ally		1 = we're allying; 0 =
 *we're breaking the alliance				*
 *                                                                         *
 * OUTPUT:                                                                 *
 *		none.
 **
