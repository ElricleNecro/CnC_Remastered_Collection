...
//	Tooltip help. Appears for the small buttons that allow users to enlarge or diminish the size of channel/user
// lists.
...
//	Title of patch download dialog. First %i = current file being downloaded, second %i = total # of files to
// download.
...
//	Appended to title of patch download dialog when resuming an interrupted download. %s is the regular title, as
// above.
...
// const char TXT_WOL_USERISSQUELCHED[]		= "%s a ÇtÇ rejetÇ.";				//	ajw rejete
// really means squelched? const char TXT_WOL_USERISNOTSQUELCHED[]		= "%s n'est plus rejetÇ.";
