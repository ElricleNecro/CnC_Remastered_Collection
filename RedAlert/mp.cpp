 ...
 *   07/01/1996 JLB : Created.                                                                 *
 *=============================================================================================*/
void XMP_Move(digit *dest, digit const *source, int precision) { memcpy(dest, source, precision * sizeof(digit)); }
...
*/
int xmp_exponent_mod(digit *expout, const digit *expin, const digit *exponent_ptr, const digit *modulus,
		     int precision) {
