...
public:
	...
	*/
	...
	//		friend Int<PRECISION> operator + (digit b, const Int<PRECISION> & a) {return(Int<PRECISION>(b) +
	// a);}
	Int operator-(const Int &number) const {
		Int term;
	...
	//		friend Int<PRECISION> operator / (digit a, const Int<PRECISION> & b) {return(Int<PRECISION>(a) /
	// b);}
	Int operator%(const Int &divisor) const {
		Int remainder;
	...
	*/
	...
	// Int<PRECISION> & eq, const Int<PRECISION> & p, const Int<PRECISION> & q, const Int<PRECISION> & u);
