				...
				if (display >= REDRAW_BACKGROUND) {
					...
					*/
					if (LogicPage->Lock()) {
						...
						// D_BORD_Y2-8; 						index +=
						// (200/ICON_PIXEL_H)) { 						LogicPage->Put_Pixel(D_BORD_X1-1, index,
						// scheme->Shadow);
						...
						*/
						...
						// txt_y += 8; 					Plain_Text_Print("Nod Unit", txt_x, txt_y, RED, TBLACK,
						// TPF_DROPSHADOW | TPF_EFNT); 					txt_y +=
