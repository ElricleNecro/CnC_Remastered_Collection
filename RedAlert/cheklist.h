...
class CheckObject {
public:
	CheckObject(char const *text = 0, bool checked = false) : Text(text), IsChecked(checked) {};
...
public:
	...
	**	character.
	*/
	typedef enum CheckListClassEnum { CHECK_CHAR = '\3', UNCHECK_CHAR = ' ' } CheckListClassEnum;
