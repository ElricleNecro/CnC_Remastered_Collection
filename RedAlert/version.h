...
//	It seems that extra information, that didn't belong there, was being stuffed into version number. Namely,
// whether or not 	Counterstrike is installed. I'm going to change things back to the way they should be, as I see
// it. Version will describe 	the version of the executable only. When it comes to communicating whether or not a
// player has expansions present, separate 	data will be transmitted.
...
// What I'll do is encode 	"does player have aftermath" (which is actually the only fact that matters, in
// multiplayer) in the communicated version 	number, as a high bit set/unset. This version of the game will receive
// this communicated value and pull out the Aftermath 	bit. Older version will reject us as a possible opponent,
// because, whether or not AM is installed, our version number will 	be too high for them.
